...
export function EcosystemBlock({className}: PageBlockProps) {
    return (
        <div className={clsx(styles.block, className)}>
            ...
            <Tag className={styles.tag} label="Сотрудники" />
            <Tag className={styles.tag} label="Финансы" />
            <Tag className={styles.tag} label="Цифровой учёт" />
            <Tag className={styles.tag} label="Клиенты" />
            <Tag className={styles.tag} label="Услуги" />
